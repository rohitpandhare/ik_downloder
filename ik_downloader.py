...
API_TOKEN = (
    "42dbe96677b0804527dc7d6bbfded7c3d0109a48"  # Replace with your actual API token
)
...
def get_arg_parser():
    ...
    parser.add_argument(
        "-q", "--query", type=str, required=True, help="Search query string"
    )
    parser.add_argument(
        "-p", "--pages", type=int, default=1, help="Number of pages to fetch"
    )
    return parser
